...
const monthlyPlans: Plan[] = [
  ...
  { id: "hobby", name: "Hobby", price: "$19.99", secondary: "per month", description: "Expanded limits for hobby projects", features: ["500 credits / mo", "10 tests", "5 projects", "15 personas", "Chat personas", "Issues board", "Parallel runs", "AI insights"], },
  { id: "pro", name: "Pro", price: "$49.99", secondary: "per month", popular: true, description: "Advanced features & higher limits", features: ["1250 credits / mo", "35 tests", "15 projects", "30 personas", "Scheduled & recurring runs", "Device types", "Chat personas", "Parallel runs", "AI insights"], },
  { id: "ultra", name: "Ultra", price: "$99.99", secondary: "per month", description: "Unlimited scale and full capabilities", features: ["2500 credits / mo", "Unlimited tests", "Unlimited projects", "Unlimited personas", "Batch personas & tests", "Scheduled & recurring runs", "Device types", "Chat personas", "Parallel runs", "AI insights"], },
];
