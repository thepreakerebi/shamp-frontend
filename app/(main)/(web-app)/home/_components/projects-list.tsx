...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <Link href={`/home/${project._id}`} className="block h-full group" prefetch={false}>
      <article
        className="rounded-2xl overflow-hidden flex flex-col bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 h-full group-hover:shadow-md transition-shadow"
      >
        {/* URL Preview */}
